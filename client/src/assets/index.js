...
export const init = () => {
    ...
    function initIntro() {
        ...
        $this.waitForImages({
            ...
            finished: function () {
                ...
                if ($this.hasClass('darken') && $('.darkover').length == 0) {
    ...
    // if (body.hasClass('mobile') && $('#menu-toggle').children('.fa').hasClass('active')) {
    ...
    $('.router-link').unbind('click');
    $('.router-link').click(function(){
        if (body.hasClass('mobile') && $('#menu-toggle').children('.fa').hasClass('active')) {
            headerNavUl.slideToggle(1);
            $('#menu-toggle').children('i').toggleClass('active');
        }
    });
    ...
    function centerOverlay() {
        ...
        var OwlItem = $('.owl-item'),
            OwlItemImage = $('.owl-item-image');

        var el = OwlItem.eq(0).attr('style');

        if(el != null) {
            var width = el.substring(7,12);

            OwlItemImage.css('width', parseInt(width)-30)
            OwlItemImage.css('height', parseInt(width)-30)
        }
    ...
    function useMockup() {
        ...
        findDevice.each(function () {
            ...
            var $this = $(this),
                ...
                deviceWrapper = $this.parent('.row-beetle-content'),
    ...
    function sideMockups() {
        ...
        sideMockup.each(function () {
            ...
            var $this = $(this),
                ...
                sideMockupParent = $this.parent('.row-beetle-content'),
        ...
        lightboxContainer.each(function () {
            ...
            var activityIndicatorOn = function () {
                ...
                closeButtonOn = function (instance) {
                    $('<a href="#" id="imagelightbox-close"><i class="icon icon-close"></i></a>').appendTo('body').unbind('click');
    ...
    if(window.innerWidth > 768){
        var defaultText = '제목을 입력해주세요'
        var editorTitle = $('#editorTitle')
        if(editorTitle.val() == '') {
            editorTitle.focus()
        } else {
            defaultText = editorTitle.val()
        } 

        var el = $('<div class="markdown-body editor-preview-title"><h1 id="preview-title">' + defaultText + '</h1></div>');
        var parent = $('.markdown-editor');
        el.appendTo(parent)
